import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as cn, U as Users, S as Skeleton } from "./index-B4zbIQCD.js";
import { u as useComposedRefs, a as useQuery, B as Badge } from "./badge-DN_RfSQs.js";
import { u as useLayoutEffect2, a as useControllableState, R as Root2$1, b as useId, P as Primitive, c as composeEventHandlers, A as Anchor, d as Portal$1, e as Arrow, f as createPopperScope, h as hideOthers, g as ReactRemoveScroll, i as createContextScope, j as createSlot, k as useFocusGuards, F as FocusScope, D as DismissableLayer, C as Content, l as ChevronDown } from "./Combination-4FQeFqkX.js";
import { t as toDate, c as constructFrom, g as getDefaultOptions, a as getTimezoneOffsetInMilliseconds, m as millisecondsInDay, b as millisecondsInWeek, e as enUS, d as millisecondsInHour, f as millisecondsInMinute, h as generateCategoricalChart, A as Area, X as XAxis, Y as YAxis, i as formatAxisMap, j as Activity, T as TrendingUp, R as ResponsiveContainer, k as Tooltip, l as formatDistanceToNow, C as CreditCard } from "./generateCategoricalChart-B301mEDh.js";
/**
...
function DateRangePicker({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Root2, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Trigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs", children: formatDisplayRange(value) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Portal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Content2,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-2 py-1.5 text-xs text-muted-foreground font-medium uppercase tracking-wider", children: "Quick ranges" }),
          PRESETS.map(({ label, days }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function generateTrend(days = 30) {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    base = Math.max(15e3, base + (Math.random() - 0.42) * 3500);
    result.push({
...
const MOCK_REVENUE_KPI = {
  totalRevenue: 1248390,
  revenueChange: 15.2,
...
const MOCK_TODAY_HIGHLIGHTS = {
  ...
  activityFeed: [
    ...
    },
    {
      ...
      timestamp: now - 1e3 * 60 * 142,
      userId: 55
    }
  ]
};
function useRevenueKPI() {
  return useQuery({
    queryKey: ["revenueKPI"],
...
function TrendBadge({
  ...
  if (isNeutral) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs font-mono text-muted-foreground", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        isPositive ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-3.5 h-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-3.5 h-3.5" }),
        isPositive ? "+" : "",
        change.toFixed(1),
        suffix
      ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-4 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-value truncate", children: value }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TrendBadge, { change, invertColor }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: changeLabel })
            ] })
          ] }),
          trend.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-12 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AreaChart,
            {
              data: trend,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Tooltip,
                  {
                    content: ({ active, payload }) => active && (payload == null ? void 0 : payload.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-popover border border-border rounded px-2 py-1 text-xs font-mono text-foreground shadow-md", children: formatCurrency(payload[0].value) }) : null
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Area,
...
function KpiCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-5 flex flex-col gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-24 h-12 rounded" })
    ] })
  ] });
}
function HealthCard({
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "data-label", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-md bg-muted flex items-center justify-center text-muted-foreground", children: icon })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-3 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-value", children: value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendBadge, { change, invertColor }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "vs prior period" }),
          isGood !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              variant: "outline",
              className: cn(
                "text-[10px] px-1.5 py-0 h-4 font-mono",
                isGood ? "border-emerald-500/30 text-emerald-400 bg-emerald-500/10" : "border-red-500/30 text-red-400 bg-red-500/10"
              ),
              children: isGood ? "Improving" : "Declining"
            }
          )
        ] })
      ]
...
function HealthCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-5 flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-24" }),
...
const EVENT_CONFIG = {
  ...
  upgrade: {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-4 h-4" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex-1 min-w-0 text-sm text-foreground leading-snug break-words", children: event.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("time", { className: "text-xs font-mono text-muted-foreground whitespace-nowrap ml-2 mt-0.5", children: formatDistanceToNow(new Date(event.timestamp), { addSuffix: true }) })
      ]
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "data-label", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "metric-value mt-0.5 truncate", children: value })
        ] })
      ]
    }
  );
...
function Dashboard() {
  const [dateRange, setDateRange] = reactExports.useState(defaultRange);
  const { data: revenueKPI, isLoading: loadingRevenue } = useRevenueKPI();
  const { data: health, isLoading: loadingHealth } = useHealthMetrics();
  const { data: highlights, isLoading: loadingHighlights } = useTodayHighlights();
  const mrr = revenueKPI ? revenueKPI.totalRevenue / 12 : 0;
  const arr = revenueKPI ? revenueKPI.totalRevenue : 0;
  const revenuePerUser = revenueKPI && health ? revenueKPI.totalRevenue / health.activeUsers : 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 mb-8 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-foreground", children: "Dashboard" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Business overview and key performance metrics" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DateRangePicker, { value: dateRange, onChange: setDateRange })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-8", "aria-label": "Revenue KPIs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeader,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4", children: loadingRevenue ? ["total", "mrr", "arr", "rpu"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCardSkeleton, {}, id)) : revenueKPI ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          KpiCard,
          {
            label: "Total Revenue",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          KpiCard,
          {
            ...
            trend: revenueKPI.trend.slice(-14).map((d) => ({
              ...d,
              amount: d.amount / ((health == null ? void 0 : health.activeUsers) ?? 12e3)
            })),
            accentColor: "#fb923c",
            gradientId: "grad-rpu"
          }
        ...
        "div",
        {
          ...
          "data-ocid": "kpi-empty",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-10 h-10 text-muted-foreground mb-3 opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No revenue data available for this period." })
          ]
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-8", "aria-label": "Business Health", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeader,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: loadingHealth ? ["churn", "conversion", "users"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(HealthCardSkeleton, {}, id)) : health ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          HealthCard,
          {
            label: "Churn Rate",
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-10 h-10 text-muted-foreground mb-3 opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No health metrics available." })
          ]
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "aria-label": "Today's Highlights", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeader,
        {
      ...
      loadingHighlights ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      ] }) : highlights ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            HighlightCard,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            HighlightCard,
            {
              ...
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "w-5 h-5 text-primary" }),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-3 border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Activity Feed" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-xs font-mono", children: [
                  highlights.activityFeed.length,
                  " events"
                ] })
              ] }),
              highlights.activityFeed.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex flex-col items-center justify-center py-10 text-center",
                  "data-ocid": "activity-empty",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-8 h-8 text-muted-foreground mb-2 opacity-40" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No activity yet today." })
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5", children: highlights.activityFeed.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityFeedItem, { event }, event.id)) })
            ]
          }
        )
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-10 h-10 text-muted-foreground mb-3 opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No highlights available." })
          ]
        }
      )
    ] })
