import { c as createLucideIcon, R as React2, f as clsx, r as reactExports, j as jsxRuntimeExports, a as cn, u as useParams, L as Link, S as Skeleton } from "./index-phnB-plz.js";
import { a as useQuery, B as Badge } from "./badge-2eGgFe6S.js";
import { n as isFunction, D as Dot, o as findAllByType, E as ErrorBar, L as Layer, p as filterProps, q as Curve, r as Animate, s as interpolateNumber, u as isEqual, v as isNil, w as hasClipDot, x as LabelList, y as getValueByDataKey, z as uniqueId, G as Global, B as getCateCoordinateOfLine, S as Shape, F as Symbols, H as adaptEventsOfChild, I as getLinearRegression, J as Cell, h as generateCategoricalChart, A as Area, K as Bar, X as XAxis, Y as YAxis, i as formatAxisMap, R as ResponsiveContainer, k as Tooltip, l as formatDistanceToNow, C as CreditCard, T as TrendingUp, j as Activity } from "./generateCategoricalChart-QTzEJy4G.js";
/**
...
var _excluded$1 = ["type", "layout", "connectNulls", "ref"], _excluded2 = ["key"];
  ...
  return _createClass$2(Line2, [{
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ React2.isValidElement(option)) {
        ...
        var key = props.key, dotProps = _objectWithoutProperties$1(props, _excluded2);
...
function MetricCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-card border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 pb-4 px-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "data-label mb-1", children: label }),
    ...
    subtext && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 font-mono", children: subtext })
  ] }) });
}
function ActivityEventRow({ event }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 flex-shrink-0 w-7 h-7 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-3.5 h-3.5 text-muted-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-snug truncate", children: event.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground mt-0.5", children: relative })
        ] })
      ]
    }
  );
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-popover border border-border rounded-md px-3 py-2 text-xs shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-muted-foreground mb-1", children: label }),
    payload.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono", style: { color: p.color }, children: p.name === "revenue" ? formatCurrency(p.value) : `${p.value} ${p.name}` }, p.name))
  ] });
}
function UserDetailSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "user-detail-skeleton", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-28" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 p-6 rounded-xl border border-border bg-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: ["rev", "sess", "pv", "la"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 rounded-lg" }, k)) }),
...
function UserDetailPage() {
  ...
  const { data, isLoading } = useUserDetail(
    Number.isNaN(numericId) ? void 0 : numericId
  );
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(UserDetailSkeleton, {});
  if (!data) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-12 h-12 text-muted-foreground mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-foreground mb-2", children: "User not found" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-3.5 h-3.5 group-hover:-translate-x-0.5 transition-smooth" }),
          "Users"
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-16 h-16 rounded-full bg-primary/20 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-mono font-semibold text-primary", children: getInitials(user.name) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-foreground truncate", children: user.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-mono truncate mt-0.5", children: user.email }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 text-right hidden sm:block", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "data-label", children: "Member since" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-sm text-foreground mt-1", children: user.signupDate })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Last Active", value: user.lastActive })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border", "data-ocid": "activity-chart", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 px-5 pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold text-foreground uppercase tracking-wider", children: "Activity — Last 30 Days" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-2 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ComposedChart,
        {
          data: chartData,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border", "data-ocid": "activity-feed", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 px-5 pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold text-foreground uppercase tracking-wider", children: "Recent Activity" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-5 pb-2", children: lastTen.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground py-4 text-center", children: "No recent activity recorded." }) : lastTen.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityEventRow, { event }, event.id)) })
    ] })
  ] });
}
export {
